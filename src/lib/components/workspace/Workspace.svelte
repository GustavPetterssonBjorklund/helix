<script lang="ts">
	import ContextMenu from './events/ContextMenu.svelte';
	...
	function onPointerDown(event: PointerEvent) {
		...
		// Allow context menu to still get clicks
...
>
	...
	<!-- Context Menu -->
	<ContextMenu x={menuX} y={menuY} open={menuOpen} onClose={closeContextMenu} />
</div>
